...
==>　
setAttribute() Method【書式】 void setAttribute(String nam, Object o)　【機能】オブジェクトに第一引数で指定したキー名で第二引数のデータを格納する。
getAttribute() Method  【書式】Obeject　getattribute(String name)【機能】オブジェクトから引数に指定した名前のキーに相当するデータを取得する。＊キー名に相当するデータが存在しない場合はNullを返す。
removeAttribute() Method 【書式】voidi removeAttribbtue(String name)【機能】オブジェクトから引数に指定した名前のキーに相当するデータを消去する。
